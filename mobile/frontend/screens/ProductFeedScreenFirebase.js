...
export default function ProductFeedScreenFirebase({ navigation }) {
  ...
  const renderItem = ({ item }) => (
    ...
    >
      ...
      <View style={styles.info}>
        ...
        <Text style={styles.firebaseLabel}>🔥 Firebase</Text>
      </View>
    </TouchableOpacity>
  );
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Loading products from Firebase...</Text>
      </View>
    );
  }
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyState}>
            ...
            <Text style={styles.firebaseEmptyLabel}>🔥 Powered by Firebase</Text>
          </View>
        }
      />
    </View>
